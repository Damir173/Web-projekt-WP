...
<p><a href="./?action=archive"  class="d-flex aligns-items-center justify-content-center">Pristupi arhivi članaka</a></p>  
  ...
  <div class="col-sm-3 hrs"> 

  <iframe src="https://www.sportinfocentar.com/livescore/unistat/indexhrs.html" width="100%" height="1300px" style="border:0px; float:right; margin-top:10px; margin-bottom:10px;"></iframe>
